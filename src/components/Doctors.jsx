function Doctors() {
    return (
        <section>
            <div className="max-w-[1300px] mx-auto py-14 flex flex-col gap-12">
                <h2 className="text-4xl font-bold text-center">Meet Our Healthcare Professionals</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-1 border-mygreen divide-x divide-y divide-mygreen">
                    <div className="bg-mylighty flex flex-col text-center">
                        <img src="" alt="" className='bg-myblack h-56 w-full' />
